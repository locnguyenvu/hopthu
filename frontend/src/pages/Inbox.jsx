...
function EmailRow({ email, isSelected, onToggle, disabled }) {
	return (
		<tr
			className={`transition-colors hover:bg-[var(--color-muted)] ${isSelected ? "bg-blue-50/50" : ""}`}
		>
		...
		<Layout>
			<div className="space-y-4 md:space-y-6">
				...
				<div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
					...
					<Button onClick={handleSync} loading={syncing} className="shrink-0">
					...
					<Card>
						<CardContent className="p-12 text-center">
							...
							<p className="text-[var(--color-muted-foreground)] mb-6">
								Sync your email accounts to get started
							</p>
